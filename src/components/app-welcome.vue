<template>
  <div class="page1">
    ...
    <div class="footer links">
      ...
      <p>
        <a title="Twitter" href="https://twitter.com/holtwick" class="brand-icon" target="_blank" rel="noopener" @click="openExternalLink($event)">
        ...
        <a title="LinkedIn" href="https://www.linkedin.com/in/holtwick/" class="brand-icon" target="_blank" rel="noopener" @click="openExternalLink($event)">
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
          </svg>
        </a>
        <a title="Product Hunt" href="https://www.producthunt.com/posts/briefing-2" class="brand-icon" target="_blank" rel="noopener" @click="openExternalLink($event)">
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a title="GitHub" href="https://github.com/holtwick/briefing/" class="brand-icon" target="_blank" rel="noopener" @click="openExternalLink($event)">
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
        ...
        <a title="Microsoft Windows App Store" href="https://www.microsoft.com/p/briefings/9pcs356fc2jf" class="brand-icon" target="_blank" rel="noopener" @click="openExternalLink($event)">
          <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801"/>
          </svg>
        </a>
        <a title="Install Progressive Web App" href="https://developer.mozilla.org/en-US/docs/Web/Progressive_web_apps/Developer_guide/Installing" class="brand-icon" target="_blank" rel="noopener" @click="openExternalLink($event)">
