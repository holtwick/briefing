<template>
  <div>
    <div class="page1">
      <div class="logo">
        <form id="form">
          <a href="#" id="link" class="link">Brie<span class="dot">.</span>fi<span class="slash">/</span>ng<span class="slash">/</span></a>
          <wbr>
          <input id="room" name="room" value="" enterkeyhint="go" spellcheck="false">
        </form>
        <div class="button-container">
          <a href="#" class="button" id="button">Start Video Chat</a>
        </div>
      </div>
      <div class="footer links">
        <p>End-to-end encrypted group video chat. <a href="#help" onclick="document.getElementById('help').scrollIntoView({behavior: 'smooth'}); return false;">Help</a></p>
        <p>Created by <a href="https://holtwick.de?ref=briefing">holtwick.de</a>
          <a title="Twitter" href="https://twitter.com/holtwick" class="icon">
          ...
          <a title="LinkedIn" href="https://www.linkedin.com/in/holtwick/" class="icon">
          ...
          <a title="Product Hunt" href="https://www.producthunt.com/posts/briefing-2" class="icon">
            <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>Product Hunt</title>
              <path
          ...
          <a title="GitHub" href="https://github.com/holtwick/briefing/issues" class="icon">
    ...
    <div class="help" id="help">
      <div class="text links">
        ...
        <p>Privacy is the driving force behind this project. It uses secure technologies like <a href='https://webrtc-security.github.io/'>WebRTC</a> to directly connect between participants. The website that provides the web app and
          mediates
        ...
        <p>The difference between Briefing and most similar projects is, that it does not use a central server that distributes the video streams (<a href='https://webrtcglossary.com/sfu/'>SFU</a>). The advantage of an SFU is that it saves
          bandwidth due to the fact that the own video does not being uploaded to each participant but only once. The SFU can also do more optimizations the clients might not support. But then the video signal is not end-to-end encrypted
          any
        ...
        <p>Frankly this is not required, because your browser can handle it all. You can of course put Briefing on your home screen e.g. in iOS Safari tap on the &quot;Share&quot; icon and choose &quot;Add to Home Screen&quot;. You can do
          the
...
html *:not(input,textarea,[contenteditable]) {
  user-select: none;
...
export default {
  ...
  async mounted() {
    ...
    function generateName() {
      ...
      return capFirst(name1[getRandomInt(0, name1.length + 1)]) + '-' + capFirst(name2[getRandomInt(0, name2.length + 1)]) + '-' + getRandomInt(1, 99)
    }
    ...
    function updateInput() {
      if (initialWidth < 0) initialWidth = input.scrollWidth
      let value = input.value.trim()
      input.style.width = '1px'
      input.style.width = (value ? input.scrollWidth : initialWidth) + 'px'
      url = '/ng/' + (value || defaultName)
      link.href = url
      button.href = url
    }
    ...
    (new ResizeObserver(updateInput)).observe(document.body)
