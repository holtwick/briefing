<template>
  <div class="page1">
    ...
    <div class="footer links">
      ...
      <p>Created by <a href="https://holtwick.de?ref=briefing" target="_blank">holtwick.de</a>
        <a title="Twitter" href="https://twitter.com/holtwick" class="icon" target="_blank">
        ...
        <a title="LinkedIn" href="https://www.linkedin.com/in/holtwick/" class="icon" target="_blank">
        ...
        <a title="Product Hunt" href="https://www.producthunt.com/posts/briefing-2" class="icon" target="_blank">
        ...
        <a title="GitHub" href="https://github.com/holtwick/briefing/issues" class="icon" target="_blank">
