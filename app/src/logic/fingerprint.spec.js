import { getFingerprint, getCompactChecksum } from './fingerprint'
...
describe('Fingerprint', () => {
  ...
  it('should extract fingerprints', () => {
    ...
    expect(fp).toEqual([108, 93, 243, 15, 114, 18, 118, 1, 211, 237, 50, 157, 238, 97, 132, 30, 214, 156, 195, 23, 56, 189, 164, 145, 252, 67, 252, 135, 3, 160, 203, 172])
    expect(fp.length).toBe(32)
    expect(fp[0]).toBe(0x6c)
    expect(fp[31]).toBe(0xac)
  })

  const fp1 = [196, 63, 157, 83, 90, 81, 216, 2, 61, 173, 111, 209, 137, 47, 209, 98, 15, 75, 225, 185, 174, 170, 36, 22, 3, 128, 144, 55, 41, 185, 35, 135]
  const fp2 = [31, 164, 75, 163, 111, 6, 101, 24, 183, 133, 185, 32, 172, 146, 3, 194, 192, 106, 134, 93, 187, 49, 70, 53, 146, 65, 156, 119, 226, 86, 16, 136]
