<template>
  ...
  <div class="app hstack" @dragover="onDragOver" @dragend="onDragEnd" @dragexit="onDragEnd" @dragleave="onDragEnd"
       @drop="onDrop">
      ...
      <div class="tools hstack">
        ...
        <div class="-fit">
          <sea-link class="tool" :class="{'-off': state.muteVideo}" @action="doVideo">
            <svg v-if="state.muteVideo" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
          ...
          <sea-link class="tool" :class="{'-off': state.muteAudio}" @action="doAudio">
            <svg v-if="state.muteAudio" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                 fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
              <line x1="1" y1="1" x2="23" y2="23"></line>
        ...
        <sea-link v-if="supportsFullscreen" @action="doToggleFullScreen" class="tool" :class="{'-active': mode === 'share'}">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
               stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" v-if="!isFullScreen">
            <path
