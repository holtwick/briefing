export default {
  ...
  share: {
    ...
    feedback:
      'Per feedback scrivere a <a href="mailto:support@holtwick.de?subject=Briefing">support@holtwick.de</a>',
    message:
      "Invita inviando il link premendo sul tasto\n" +
  ...
  settings: {
    ...
    blur_info:
      "Sperimentale: un algoritmo di intelligenza artificiale è in grado di individuare le forme delle persone e sfocare lo sfondo rimanente. Questo aggiunge un po di privacy visiva alla tua chiamata. Ma attenzione, questa è una funzione che consuma molto energia e molto probabilmente non funzionerà su dispositivi mobili! ",
    bandwidth: "Applica ottimizzazioni della larghezza di banda",
    bandwidth_info:
      "Sperimentale: con questa impostazione,briefing cerca di ridurre la larghezza di banda assottigliando i dati video e audio.",
    fill: "Scala video",
    fill_info:
      "Il briefing cerca di sfruttare il più possibile lo spazio disponibile sullo schermo ridimensionando il video in modo da adattarlo alla sua cornice visiva. Quando è spento, vedrai invece l'intero video ma con bordi attorno.",
    subscribe: "Iscriviti a questa stanza",
    subscribe_info:
      "Sperimentale: iscrivendoti riceverai una notifica quando qualcun altro entra in questa stanza. È quindi possibile partecipare alla conversazione con un clic. Le notifiche verranno visualizzate solo se il browser è in esecuzione.",
